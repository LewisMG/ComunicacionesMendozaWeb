...
namespace ComunicacionesMendozaAP2 {
    ...
    public partial class ProductosDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductosDataTable : global::System.Data.TypedTableBase<ProductosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ProductosRow AddProductosRow(System.DateTime Fecha, string Descripcion, int Costo, int Ganancia, int Precio, int Inventario) {
        ...
        public partial class ProductosRow : global::System.Data.DataRow {
            ...
            public int Ganancia {
                get {
                    return ((int)(this[this.tableProductos.GananciaColumn]));
                }
                set {
...
namespace ComunicacionesMendozaAP2.ProductosDataSetTableAdapters {
    ...
    public partial class ProductosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Productos] ([Fecha], [Descripcion], [Costo], [Ganancia], [Prec" +
                "io], [Inventario]) VALUES (@Fecha, @Descripcion, @Costo, @Ganancia, @Precio, @In" +
                "ventario)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Productos] SET [Fecha] = @Fecha, [Descripcion] = @Descripcion, [Cos" +
                "to] = @Costo, [Ganancia] = @Ganancia, [Precio] = @Precio, [Inventario] = @Invent" +
                "ario WHERE (([ProductoId] = @Original_ProductoId))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductoId, Fecha, Descripcion, Costo, Ganancia, Precio, Inventario FROM d" +
                "bo.Productos";
        ...
        public virtual int Insert(System.DateTime Fecha, string Descripcion, int Costo, int Ganancia, int Precio, int Inventario) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(Ganancia));
        ...
        public virtual int Update(System.DateTime Fecha, string Descripcion, int Costo, int Ganancia, int Precio, int Inventario, int Original_ProductoId) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Ganancia));
