<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="cProductos.aspx.cs" Inherits="ComunicacionesMendozaAP2.UI.Consultas.cProductos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="jumbotron" style="background-color: #46a58b">
        <hr>
        <h5 class="display-4" style="color: #005a65; font-weight: bold;">Consulta de Productos</h5>
        <hr>
            ...
            <div class="modal-dialog modal-lg" style="max-width: 1000px!important; min-width: 980px!important">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Litado de Producto</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <rsweb:ReportViewer ID="ProductosReportViewer" runat="server" ProcessingMode="Remote" Height="1000px" Width="980px">
